...
NET_PROC_PBC = pd.read_csv('NET_PROC_PBC_AUC_Table.csv')
NET_PROC_WPBC2 = pd.read_csv('NET_PROC_WPBC2_AUC_Table.csv')
NET_PROC_WPIBC = pd.read_csv('NET_PROC_AUC_Table_WPIBC.csv')
df = pd.concat([df , NET_PROC_BBC, NET_PROC_IBC, NET_PROC_PBC, NET_PROC_WPBC2, NET_PROC_WPIBC], axis=1, join='outer')
