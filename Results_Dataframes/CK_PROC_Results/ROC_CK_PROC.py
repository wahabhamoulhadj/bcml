...
print(df1)
roc_curves_tpr_list = np.load('CK_PROC_all_six_models_tpr.npy', allow_pickle=True)
roc_curves_fpr_list = np.load('CK_PROC_all_six_models_fpr.npy', allow_pickle=True)
bbc_fpr = np.load('CK_PROC_bbc_roc_fpr.npy', allow_pickle=True)
bbc_tpr = np.load('CK_PROC_bbc_roc_tpr.npy', allow_pickle=True)
# bbc_tpr = np.array(bbc_tpr)
# bbc_fpr = np.array(bbc_fpr)

ibc_fpr = np.load('CK_PROC_ibc_roc_fpr.npy', allow_pickle=True)
ibc_tpr = np.load('CK_PROC_ibc_roc_tpr.npy', allow_pickle=True)

pbc_fpr = np.load('CK_PROC_pbc_roc_fpr.npy', allow_pickle=True)
pbc_tpr = np.load('CK_PROC_pbc_roc_tpr.npy', allow_pickle=True)

wpibc_fpr = np.load('CK_PROC_wpibc_roc_fpr.npy', allow_pickle=True)
wpibc_tpr = np.load('CK_PROC_wpibc_roc_tpr.npy', allow_pickle=True)

wpbc2_fpr = np.load('CK_PROC_WPBC2_roc_fpr.npy', allow_pickle=True)
wpbc2_tpr = np.load('CK_PROC_WPBC2_roc_tpr.npy', allow_pickle=True)
...
for count in range(len(df)):
    ...
    plt.legend(["Naive Bayes AUC : {:.3f}".format(df.iloc[count][1]),
                ...
                "PBC AUC : {:.3f} ".format(pd.read_csv('CK_PROC_PBC_AUC_Table.csv').iloc[count][1]),
