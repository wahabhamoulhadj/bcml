...
dir_path = "../../PROMIS/CK_NET_PROC/*.csv"  # Path to dataset
...
np.save('CK_NET_PROC_all_six_models_predict_proba', np.array(smpdf[0], dtype=object))
np.save('CK_NET_PROC_all_six_models_fpr', np.array(smpdf[2], dtype=object))
np.save('CK_NET_PROC_all_six_models_tpr', np.array(smpdf[3], dtype=object))
...
df.to_csv('CK_NET_PROC_all_six_models_auc.csv')
